...
protected:
    ...
    void SearchAndFuse(const KeyFrameAndPose &CorrectedPosesMap, vector<MapPointPtr> &vpMapPoints, vector<MapLinePtr> &vpMapLines);
    void SearchAndFuse(const vector<KeyFramePtr> &vConectedKFs, vector<MapPointPtr> &vpMapPoints, vector<MapLinePtr> &vpMapLines);
