...
public:
    ...
    void AddMapObjects(MapObject* pMO);
    void EraseMapObject(MapObject *pMO);
    void SetReferenceMapObjects(const std::vector<MapObjectPtr> &vpMOs);
    ...
    void GetSetOfReferenceMapObjects(std::set<MapObjectPtr>& setMOs);
...
protected:
    ...
    std::vector<MapObjectPtr> mvpReferenceObjects;
