...
{
    double inter_w = std::max(std::min(bb1[2], bb2[2]) - std::max(bb1[0], bb2[0]), 0.0f);
    double inter_h = std::max(std::min(bb1[3], bb2[3]) - std::max(bb1[1], bb2[1]), 0.0f);
