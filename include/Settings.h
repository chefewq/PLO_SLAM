...
namespace ORB_SLAM3 {
    ...
    public:
        ...
        */
        ...
        std::string yoloEigen() const { return yoloEigenPath_;}
        std::string sortEigen() const { return sortEigenPath_;}
    ...
    private:
        ...
        void readTensortEigen(cv::FileStorage& fSettings);

        void readViewer(cv::FileStorage& fSettings);
        void readLoadAndSave(cv::FileStorage& fSettings);
        void readOtherParameters(cv::FileStorage& fSettings);
        
        void readEigen(cv::FileStorage& fSettings);
        ...
        std::string  yoloEigenPath_;
        std::string  sortEigenPath_;
