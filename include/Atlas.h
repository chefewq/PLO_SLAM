...
public:
    ...
    void AddMapLine(MapLinePtr pML);
    ...
    Map* GetCurrentMap();
    Map*& GetCurrenMapRef() { return mpCurrentMap; }
    ...
    long unsigned int GetNumLivedML();    
...
public: /// < signals 
    ...
    Signal<Map*> mSignalCreateNewMap;    
    Signal<Map*> mSignalChangeMap;   
    Signal<Map*> mSignalClearMap;      
    Signal<>     mSignalClearAtlas;    
    Signal<Map*> mSignalSetMapBad;     
    Signal<>     mSignalRemoveBadMaps;
    
public: 
    
    bool mnEnableLoopClosing = true;
