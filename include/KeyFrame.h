...
public:
    ...
    const std::vector<cv::KeyPoint> mvObjectsKeys;
    const std::vector<float> mvObjectsDepth;
    ...
    //Object
    const int N_O;
    const std::vector<cv::KeyPoint> mvObjectKeys;
    const std::vector<float> mvObjectDepth;
    const cv::Mat mvObjectsDescriptors;
