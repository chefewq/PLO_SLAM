...
float KeyFrame::skFovCenterDistance = 1.5;
...
KeyFrame::KeyFrame():
        ...
        // points
        N(0),N_O(0),mvObjectDepth(static_cast<vector<float> >(NULL)),mvObjectKeys(static_cast<vector<cv::KeyPoint> >(NULL)), mvKeys(static_cast<vector<cv::KeyPoint> >(NULL)), mvKeysUn(static_cast<vector<cv::KeyPoint> >(NULL)),
...
KeyFrame::KeyFrame(Frame &F, Map *pMap, KeyFrameDatabase *pKFDB):
    ...
    //Object
    N_O(F.N_O),mvObjectsDepth(F.mvObjectsDepth),mvObjectsDescriptors(F.mvObjectsDescriptors),
    mvObjectKeys(F.mvObjectsKeys),
    // lines
